pub const LED_COUNT: i32 = 600 as i32;     // Number of LED pixels.
pub const LED_PIN: i32 = 18 as i32;      // GPIO pin connected to the pixels (must support PWM!).
...
pub const LED_INVERT: bool = false;   // True to invert the signal (when using NPN transistor level shift)
